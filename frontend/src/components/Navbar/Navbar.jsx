...
const Navbar = () => {
  const { user, signOutUser } = useAuth(); // Using the correct function name from AuthProvider
  ...
  const handleSignOut = async () => {
    try {
      await signOutUser(); // Using the correct function name
    } catch (error) {
            ...
            <div className="dropdown dropdown-bottom dropdown-end">
              <label tabIndex={0} className="">
                <img
                  ...
                  src={user?.photoURL || "https://i.pravatar.cc/300"} // Fallback avatar
