...
const Chat = ({ receiver }) => {
  ...
  return (
    <div className="chat-container bg-white dark:bg-gray-800 rounded-lg shadow-md flex flex-col h-full">
      <div className="chat-header bg-main text-white p-4 rounded-t-lg">
      ...
      <form onSubmit={sendMessage} className="chat-input p-4 border-t">
        <div className="flex space-x-2">
          ...
          <button
            ...
            className="bg-main text-white px-4 py-2 rounded-md hover:bg-opacity-90 disabled:opacity-50"
          >
            Send
          </button>
        </div>
