...
const Instructor = ({ course }) => {
    ...
    console.log('Instructor courses:', instructor.instructorCourses);
        ...
        <div className="space-y-6">
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <p className="text-2xl font-bold text-gray-900 dark:text-white">{instructor.courses || 0}</p>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <p className="text-2xl font-bold text-gray-900 dark:text-white">{instructor.students || 0}</p>
            ...
            <div className="mt-8">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    {Array.isArray(instructor.instructorCourses) && instructor.instructorCourses.length > 0 ? (
                        instructor.instructorCourses.map((course) => (
                            <div key={course._id} className="group">
                                ...
                                <div className="mt-4">
                                    ...
                                    <p className="mt-2 text-blue-600 dark:text-blue-400">${course.price}</p>
                                </div>
                            </div>
                        ))
                    ) : (
                        <div className="col-span-3 text-center py-8">
                            <p className="text-gray-500 dark:text-gray-400">No other courses by this instructor yet.</p>
                        </div>
                    )}
                </div>
            </div>
