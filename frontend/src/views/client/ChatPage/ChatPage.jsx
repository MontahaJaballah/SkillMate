        ...
        <div className="md:col-span-1 bg-white dark:bg-gray-800 rounded-lg shadow-md p-4">
          <div className="mb-4">
            <div className="flex space-x-2 mb-4">
              <button 
                className={`px-4 py-2 rounded-md ${activeTab === 'friends' ? 'bg-main text-white' : 'bg-gray-200 text-gray-700'}`}
                onClick={() => setActiveTab('friends')}
              >
                Friends
              </button>
              <button 
                className={`px-4 py-2 rounded-md ${activeTab === 'requests' ? 'bg-main text-white' : 'bg-gray-200 text-gray-700'}`}
              ...
              <button 
                className={`px-4 py-2 rounded-md ${activeTab === 'find' ? 'bg-main text-white' : 'bg-gray-200 text-gray-700'}`}
                    ...
                    <li key={request._id} className="p-3 rounded-md border border-gray-200">
                      ...
                      <div className="flex space-x-2">
                        <button
                          ...
                          className="bg-main text-white px-3 py-1 rounded text-sm hover:bg-opacity-80"
                        >
                          Accept
                        </button>
                        <button
