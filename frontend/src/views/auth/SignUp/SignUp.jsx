...
const SignUp = () => {
  const { signUpUser, user, handleLinkedInSignUp, handleGoogleSignUp, updateUser } = useAuth();
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-purple-900 dark:to-indigo-900 py-6 px-4 sm:px-6 lg:px-8">
      <Helmet>
        <title>Sign Up</title>
      </Helmet>
      <div className="w-full max-w-md sm:max-w-lg md:max-w-2xl mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-2xl p-6 sm:p-8 space-y-6 transform hover:scale-[1.02] transition-transform duration-300">
        <div className="text-center">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600 mb-2">
            Join Our Community
          </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-6 border-t border-gray-200 dark:border-gray-700 pt-6">
              ...
              <div className="form-control">
                ...
                <div className="space-y-2">
                  ...
                  <button
                    ...
                    className="btn w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white border-none disabled:from-gray-400 disabled:to-gray-500"
                  >
                    Add Subject
                  </button>
                </div>
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  {formData.teachingSubjects.map((subject, index) => (
                    <div
                      key={index}
                      className="group relative flex items-center px-3 py-1 sm:px-4 sm:py-2 rounded-lg bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/50 dark:to-pink-900/50 shadow-sm hover:shadow-md transition-all duration-200"
                    >
                      <span className="text-purple-800 dark:text-purple-200 text-sm sm:text-base">{subject}</span>
                      <button
                        type="button"
              ...
              <div className="form-control">
                ...
                <div className="flex flex-col items-center space-y-4">
                  ...
                  />
                  {certPreview && (
                    <div className="max-w-full w-48 sm:w-64">
                      {typeof certPreview === 'string' && certPreview.startsWith('PDF') ? (
                        <div className="p-4 bg-purple-50 dark:bg-purple-900 rounded-lg text-center">
                          <svg className="w-6 h-6 sm:w-8 sm:h-8 mx-auto text-purple-600 dark:text-purple-400 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
                          </svg>
                          <span className="text-purple-800 dark:text-purple-200 text-sm sm:text-base">{certPreview}</span>
                        </div>
                      ) : (
                        <img
                          src={certPreview}
          ...
          <div className="flex justify-center">
            <ReCAPTCHA
              ...
              theme="light"
              className="transform scale-90 sm:scale-100 hover:scale-105 transition-transform duration-300"
            />
          </div>
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:gap-4">
            <button
              ...
              className="btn btn-outline w-full sm:w-auto flex items-center justify-center gap-2 hover:bg-red-600 hover:border-red-600 text-sm sm:text-base py-2 sm:py-3"
            >
              <img src="/assets/images/google.svg" alt="Google" className="w-4 h-4 sm:w-5 sm:h-5" />
              Sign up with Google
            </button>
            <button
              type="button"
              onClick={handleLinkedInSignUp}
              className="btn btn-outline w-full sm:w-auto flex items-center justify-center gap-2 hover:bg-blue-600 hover:border-blue-600 text-sm sm:text-base py-2 sm:py-3"
            >
              <img src="/assets/images/linkedin.svg" alt="LinkedIn" className="w-4 h-4 sm:w-5 sm:h-5" />
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full btn bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-bold py-2 sm:py-3 rounded-lg transform hover:scale-105 transition-all duration-300 disabled:opacity-50"
          >
            {loading ? (
